...
namespace Dental_IT.Droid.Adapters
{
    class RecyclerViewAdapter_SearchHospital : RecyclerView.Adapter
    {
        ...
        public RecyclerViewAdapter_SearchHospital(Context c, List<Hospital> l, List<int> p, List<ToggleState> temp)
        {
            context = c;
            hospitalList = l;
            prefList = p;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            holder.ItemView.Click += delegate
            {
                ...
                intent.PutExtra("details_Hospital", Newtonsoft.Json.JsonConvert.SerializeObject(hospitalList[holder.AdapterPosition]));
